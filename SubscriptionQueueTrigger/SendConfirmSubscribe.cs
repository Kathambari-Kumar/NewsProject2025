...
namespace SubscriptionQueueTrigger
{
    public class SendConfirmSubscribe
    {
        private readonly IConfiguration _configuration;

        public SendConfirmSubscribe(IConfiguration configuration)
        {

            _configuration = configuration;
        }

        [FunctionName("SendConfirmSubscribe")]
        public async Task Run([QueueTrigger("subscriptionsqueue", Connection = "AzureWebJobsStorage")] QueueMessageFM myQueueItem, ILogger log)
        {
            ...
            message.Body = new TextPart(TextFormat.Html) { Text = $"Thank you {myQueueItem.Name} for your subscription!" };
