...
{
    public class MailNewsLetterToUsersDD
    {
        private readonly IConfiguration _configuration;
        public MailNewsLetterToUsersDD(IConfiguration configuration)
        {
            _configuration = configuration;
        }
        [FunctionName("MailNewsLetterToUsersDD")]
        public Task Run([QueueTrigger("newsletterqueue", Connection = "AzureWebJobsStorage")]QueueItemFM queueItem, ILogger log)
        {
            ...
            {
                body.AppendLine("<a href=\"\">" + "<strong>" + item.LinkText + "</strong>" + "</a>" + "<br/>");
            ...
            body.AppendLine("<hr/>");
            body.AppendLine("<b>For more News, visit our website : </b>" + "<a href=\"\">" + "Digital Drgons " + "</a>");
            body.AppendLine("<hr/>");
