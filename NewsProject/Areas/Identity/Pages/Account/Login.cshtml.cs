...
namespace NewsProject.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<User> signInManager, ILogger<LoginModel> logger,
                    ISubscriptionService subscriptionService,IHttpContextAccessor httpContextAccessor)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        bool hasActiveSubscription = _subscriptionService.HasActiveSubscription(user.Id);
                    ...
                    if (session.GetString("ProductCart") != null)
                    {
                        // if the user has something on cart, return to display cart
                        return RedirectToAction("DisplayCart", "Product");
                    }
